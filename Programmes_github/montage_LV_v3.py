...
def valide():
    ...
    del liste_message[0]
    canvas.itemconfig(canvas_image,image= image_validee)
    canvas.update()
    time.sleep(2)
    update_image()
...
width = 650
height = 600
image_avant = PhotoImage(file= "Montage_LV_avant.png").zoom(1).subsample(1)
image_arriere = PhotoImage(file= "Montage_LV_arriere.png").zoom(1).subsample(1)
image_attente = PhotoImage(file= "attente.png").zoom(1).subsample(1)
image_EPI = PhotoImage(file= "EPI.png").zoom(1).subsample(2)
image_validee = PhotoImage(file= "portiere_validee.png").zoom(1).subsample(1)
