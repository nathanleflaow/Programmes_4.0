...
width = 650
height = 600
image_avant = PhotoImage(file= "C:/Users/natha/Desktop/ECAM/ECAM/Usine_4.0/Programmes_Python/Main_program/Montage_LV_avant.png").zoom(1).subsample(2)
image_arriere = PhotoImage(file= "C:/Users/natha/Desktop/ECAM/ECAM/Usine_4.0/Programmes_Python/Main_program/Montage_LV_arriere.png").zoom(1).subsample(2)
...
label_title = Label(root, text = "Montage Lève vitre", font=("Helvetica", 15), bg='#7F8FA6', pady = 20)
...
button_EPI = Button(root, text = "EPI", command = EPI, font=("Helvetica", 10), height = 2, width = 5)
